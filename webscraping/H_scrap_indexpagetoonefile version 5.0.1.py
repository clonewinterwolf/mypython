...
index_url = "https://www.jinyongwang.net/nfei/" #the url of index page containing url of all chapters
...
chinese_numberchar_unicode = ['\u4e00','\u4e8c','\u4e09','\u56db','\u4e94','\u516d','\u4e03','\u516b','\u4e5d','\u5341','\u8bb0'] #chinese char,一...十,后记
...
if(chapter_link_ordered): 
    for chapter in chapter_list:
        ...
        if (chapter.get_text()[chinese_num_index] in chinese_numberchar_unicode): #Change index to chapter.get_text()[1] if chapter title is  第一...
            ...
            save_chapter_content_tofile(chapter_url, chapter.a.get_text(), chapter_find_pattern, book_filepath)
        else:
    ...
    for index in range(0, totalrow):
        for j in range(0, totalcol):
            ...
            if ((chapter_index < chapter_endindex) and (chapter_list[chapter_index].get_text()[1] in chinese_numberchar_unicode)): #Change index to chapter.get_text()[1] if chapter title is  第一...
                ...
                save_chapter_content_tofile(newurl, chapter_list[chapter_index].a.get_text(), chapter_find_pattern, book_filepath)
            else:
                print("skipped")